...
namespace Tester
{
  ...
  public sealed class PdfParserTests
  {
    ...
    public void BaseDocTest()
    {
      ...
      PDF_CRefEntry c = new PDF_CRefEntry { TenDigitValue = 0, GenerationNumber = 65535, EntryType = PDF_XrefEntryType.FREE };
      Assert.IsTrue(cRefTableEntries[0] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10702, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[1] == c);
      c = new PDF_CRefEntry { TenDigitValue = 281, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[2] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3265, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[3] == c);
      c = new PDF_CRefEntry { TenDigitValue = 22, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[4] == c);
      c = new PDF_CRefEntry { TenDigitValue = 262, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[5] == c);
      c = new PDF_CRefEntry { TenDigitValue = 385, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[6] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3229, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[7] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3398, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[8] == c);
      c = new PDF_CRefEntry { TenDigitValue = 6511, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[9] == c);
      c = new PDF_CRefEntry { TenDigitValue = 493, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[10] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3208, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[11] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3348, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[12] == c);
      c = new PDF_CRefEntry { TenDigitValue = 3773, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[13] == c);
      c = new PDF_CRefEntry { TenDigitValue = 4032, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[14] == c);
      c = new PDF_CRefEntry { TenDigitValue = 6490, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[15] == c);
      c = new PDF_CRefEntry { TenDigitValue = 6893, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[16] == c);
      c = new PDF_CRefEntry { TenDigitValue = 7153, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[17] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10586, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[18] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10607, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[19] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10660, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
    ...
    public void SampleDocTest()
    {
      ...
      c = new PDF_CRefEntry { TenDigitValue = 138560, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 19, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 2806, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 138722, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 2827, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 6544, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 138866, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 6565, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10276, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 139010, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10297, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10502, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 10523, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 141115, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 140996, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 61445, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 73054, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 73077, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 73272, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 73769, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 74103, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 81507, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 81529, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 81725, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 82091, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 82317, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 91907, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 91929, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 92129, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 92531, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 92791, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 100402, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 100424, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 100627, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 101037, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 101308, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 136140, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 136163, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 136346, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 137411, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 138386, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 138459, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 139156, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 139212, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 139626, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 139956, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 140304, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 140690, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 141271, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new PDF_CRefEntry { TenDigitValue = 141386, GenerationNumber = 0, EntryType = PDF_XrefEntryType.NORMAL };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
