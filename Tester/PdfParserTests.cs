...
namespace Tester
{
  ...
  public sealed class PdfParserTests
  {
    ...
    public void BaseDocTest()
    {
      ...
      FontData tt2FData = resourceDict.Font[0];
      FontInfo tt2FI = tt2FData.FontInfo;
      ...
      FontData tt1FData = resourceDict.Font[1];
      FontInfo tt1FI = tt1FData.FontInfo;
    ...
    public void SampleDocTest()
    {
      ...
      Assert.IsTrue(pdfFile.PdfVersion == PDFVersion.V1_4);
      ...
      c = new CRefEntry { TenDigitValue = 138560, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 19, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 2806, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 138722, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 2827, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 6544, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 138866, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 6565, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 10276, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 139010, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 10297, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 10502, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 10523, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 141115, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 140996, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 61445, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 73054, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 73077, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 73272, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 73769, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 74103, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 81507, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 81529, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 81725, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 82091, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 82317, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 91907, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 91929, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 92129, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 92531, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 92791, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 100402, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 100424, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 100627, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 101037, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 101308, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 136140, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 136163, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 136346, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 137411, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 138386, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 138459, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 139156, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 139212, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 139626, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 139956, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 140304, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 140690, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 141271, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      c = new CRefEntry { TenDigitValue = 141386, GenerationNumber = 0, EntryType = (byte)'n' };
      Assert.IsTrue(cRefTableEntries[cRefIndex++] == c);
      ...
      Assert.IsTrue(pdfFile.PageInformation[0].ContentDict.Filters[0] == Filter.FlateDecode);
      Assert.IsTrue(pdfFile.PageInformation[1].ContentDict.Filters[0] == Filter.FlateDecode);
      Assert.IsTrue(pdfFile.PageInformation[2].ContentDict.Filters[0] == Filter.FlateDecode);
      Assert.IsTrue(pdfFile.PageInformation[3].ContentDict.Filters[0] == Filter.FlateDecode);
